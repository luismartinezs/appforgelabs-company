...
0 1 * * * cd /home/deploy/company && claude -p "Use the atlas-ceo subagent to handle task ./tasks/ceo-onboard.md" --dangerously-skip-permissions >> logs/conversation.md 2>&1 && git add logs/conversation.md && git commit -m "ops: append conversation log" || true && git push origin main
